...
cp /media/iceows/Projets/iceows/leaos-21.2/build-output/LeaOS-21.0-${srcDateFile}-arm64_byN.img  /media/iceows/Sauvegardes/ice-rom/LeaOS/21.0/
cp /media/iceows/Projets/iceows/leaos-21.2/build-output/LeaOS-21.0-${srcDateFile}-arm64_boN.img  /media/iceows/Sauvegardes/ice-rom/LeaOS/21.0/
...
# Google
sudo bash ./run-huawei-emui9-ab-a14.sh /media/iceows/Projets/iceows/leaos-21.2/build-output/LeaOS-21.0-${srcDateFile}-arm64_byN.img "LeaOS" "POT-LX1" "N" "Y"
mv s-erofs.img /media/iceows/Sauvegardes/ice-rom/LeaOS/21.0/LeaOS-21.0-${srcDateFile}-iceows-google-pot.img
sudo bash ./run-huawei-emui9-ab-a14.sh /media/iceows/Projets/iceows/leaos-21.2/build-output/LeaOS-21.0-${srcDateFile}-arm64_byN.img "LeaOS" "ANE-LX1" "N" "N"
mv s-vndklite.img /media/iceows/Sauvegardes/ice-rom/LeaOS/21.0/LeaOS-21.0-${srcDateFile}-iceows-google-ane.img

# Vanilia
sudo bash ./run-huawei-emui9-ab-a14.sh /media/iceows/Projets/iceows/leaos-21.2/build-output/LeaOS-21.0-${srcDateFile}-arm64_boN.img "LeaOS" "POT-LX1" "N" "Y"
mv s-erofs.img /media/iceows/Sauvegardes/ice-rom/LeaOS/21.0/LeaOS-21.0-${srcDateFile}-iceows-pot.img
sudo bash ./run-huawei-emui9-ab-a14.sh /media/iceows/Projets/iceows/leaos-21.2/build-output/LeaOS-21.0-${srcDateFile}-arm64_boN.img "LeaOS" "ANE-LX1" "N" "N"
