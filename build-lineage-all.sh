...
# Vanilia
sudo bash ./run-huawei-ab-a13.sh /home/iceows/build-output/LeaOS-20.0-${srcDateFile}-arm64_bvN.img "LeaOS" "ANE-LX1" "N"
mv s-vndklite.img /media/iceows/Sauvegardes/ice-rom/LeaOS/20.0/LeaOS-20.0-${srcDateFile}-iceows-ane.img
sudo bash ./run-huawei-ab-a13.sh /home/iceows/build-output/LeaOS-20.0-${srcDateFile}-arm64_bvN.img "LeaOS" "FIG-LX1" "N"
mv s-vndklite.img /media/iceows/Sauvegardes/ice-rom/LeaOS/20.0/LeaOS-20.0-${srcDateFile}-iceows-fig.img
sudo bash ./run-huawei-ab-a13.sh /home/iceows/build-output/LeaOS-20.0-${srcDateFile}-arm64_bvN.img "LeaOS" "STF-L09" "N"
mv s-vndklite.img /media/iceows/Sauvegardes/ice-rom/LeaOS/20.0/LeaOS-20.0-${srcDateFile}-iceows-stf.img
sudo bash ./run-huawei-ab-a13.sh /home/iceows/build-output/LeaOS-20.0-${srcDateFile}-arm64_bvN.img "LeaOS" "COR-AL00" "N"
mv s-vndklite.img /media/iceows/Sauvegardes/ice-rom/LeaOS/20.0/LeaOS-20.0-${srcDateFile}-iceows-cor.img
sudo bash ./run-huawei-ab-a13.sh /home/iceows/build-output/LeaOS-20.0-${srcDateFile}-arm64_bvN.img "LeaOS" "VTR-L09" "N"
mv s-vndklite.img /media/iceows/Sauvegardes/ice-rom/LeaOS/20.0/LeaOS-20.0-${srcDateFile}-iceows-vtr.img
sudo bash ./run-huawei-ab-a13.sh /home/iceows/build-output/LeaOS-20.0-${srcDateFile}-arm64_bvN.img "LeaOS" "POT-LX1" "N"
...
xz -cv /media/iceows/Sauvegardes/ice-rom/LeaOS/20.0/LeaOS-20.0-${srcDateFile}-iceows-pot.img -T0 > /media/iceows/Sauvegardes/ice-rom/LeaOS/20.0/LeaOS-20.0-${srcDateFile}-iceows-pot.img.xz

# Google
sudo bash ./run-huawei-ab-a13.sh /home/iceows/build-output/LeaOS-20.0-${srcDateFile}-arm64_bgN.img "LeaOS" "ANE-LX1" "N"
mv s-vndklite.img /media/iceows/Sauvegardes/ice-rom/LeaOS/20.0/LeaOS-20.0-${srcDateFile}-iceows-google-ane.img
sudo bash ./run-huawei-ab-a13.sh /home/iceows/build-output/LeaOS-20.0-${srcDateFile}-arm64_bgN.img "LeaOS" "FIG-LX1" "N"
mv s-vndklite.img /media/iceows/Sauvegardes/ice-rom/LeaOS/20.0/LeaOS-20.0-${srcDateFile}-iceows-google-fig.img
sudo bash ./run-huawei-ab-a13.sh /home/iceows/build-output/LeaOS-20.0-${srcDateFile}-arm64_bgN.img "LeaOS" "STF-L09" "N"
mv s-vndklite.img /media/iceows/Sauvegardes/ice-rom/LeaOS/20.0/LeaOS-20.0-${srcDateFile}-iceows-google-stf.img
sudo bash ./run-huawei-ab-a13.sh /home/iceows/build-output/LeaOS-20.0-${srcDateFile}-arm64_bgN.img "LeaOS" "COR-AL00" "N"
mv s-vndklite.img /media/iceows/Sauvegardes/ice-rom/LeaOS/20.0/LeaOS-20.0-${srcDateFile}-iceows-google-cor.img
sudo bash ./run-huawei-ab-a13.sh /home/iceows/build-output/LeaOS-20.0-${srcDateFile}-arm64_bgN.img "LeaOS" "VTR-L09" "N"
mv s-vndklite.img /media/iceows/Sauvegardes/ice-rom/LeaOS/20.0/LeaOS-20.0-${srcDateFile}-iceows-google-vtr.img
sudo bash ./run-huawei-ab-a13.sh /home/iceows/build-output/LeaOS-20.0-${srcDateFile}-arm64_bgN.img "LeaOS" "POT-LX1" "N"
mv s-erofs.img /media/iceows/Sauvegardes/ice-rom/LeaOS/20.0/LeaOS-20.0-${srcDateFile}-iceows-google-pot.img
...
xz -cv /media/iceows/Sauvegardes/ice-rom/LeaOS/20.0/LeaOS-20.0-${srcDateFile}-iceows-google-pot.img -T0 > /media/iceows/Sauvegardes/ice-rom/LeaOS/20.0/LeaOS-20.0-${srcDateFile}-iceows-google-pot.img.xz
