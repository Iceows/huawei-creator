...
for model in arm64_bvN arm64_bgN arm64_evN arm64_egN arm64_vvN arm64_vgN;do
	lftp sftp://altairfr:xxx@frs.sourceforge.net -e "cd /home/frs/project/altairfr-huawei/TrebleDroid-GSI ;put /media/iceows/Sauvegardes/ice-rom/TrebleDroid/TrebleDroid-A13-${srcDateFile}-treble_${model}.xz; bye"
done
