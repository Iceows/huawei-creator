...
(
	...
	echo "(type huawei_hiai_ddk_api_version_prop)" >> etc/selinux/plat_sepolicy.cil
	echo "(roletype object_r huawei_hiai_ddk_api_version_prop)" >> etc/selinux/plat_sepolicy.cil
